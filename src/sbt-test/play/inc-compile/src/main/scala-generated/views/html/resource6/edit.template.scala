...
"""),format.raw/*4.1*/("""
"""),_display_(Seq[Any](/*5.2*/form(id.map(id => routes.Resource6.update(id)).getOrElse(routes.Resource6.create()))/*5.86*/ {_display_(Seq[Any](format.raw/*5.88*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource6/edit.scala.html
                    HASH: a562f2b0ed5f941ea9f670b8d80b3eb4ebe67ea4
