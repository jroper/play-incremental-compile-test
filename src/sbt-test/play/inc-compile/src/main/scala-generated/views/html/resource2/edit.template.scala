...
"""),format.raw/*4.1*/("""
"""),_display_(Seq[Any](/*5.2*/form(id.map(id => routes.Resource2.update(id)).getOrElse(routes.Resource2.create()))/*5.86*/ {_display_(Seq[Any](format.raw/*5.88*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource2/edit.scala.html
                    HASH: 9675af9ab8242f876735fdc7e4e9a12f53f0e2cb
