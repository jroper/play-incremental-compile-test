...
"""),format.raw/*4.1*/("""
"""),_display_(Seq[Any](/*5.2*/form(id.map(id => routes.Resource4.update(id)).getOrElse(routes.Resource4.create()))/*5.86*/ {_display_(Seq[Any](format.raw/*5.88*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource4/edit.scala.html
                    HASH: 114e4f82cff2874b5805d63b241cc67e4dce2fd4
