...
"""),format.raw/*4.1*/("""
"""),_display_(Seq[Any](/*5.2*/form(id.map(id => routes.Resource5.update(id)).getOrElse(routes.Resource5.create()))/*5.86*/ {_display_(Seq[Any](format.raw/*5.88*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource5/edit.scala.html
                    HASH: babd0efd162ebed9c114695aefe90fc283dd505a
