...
"""),format.raw/*4.1*/("""
"""),_display_(Seq[Any](/*5.2*/form(id.map(id => routes.Resource1.update(id)).getOrElse(routes.Resource1.create()))/*5.86*/ {_display_(Seq[Any](format.raw/*5.88*/("""
...
"""))}
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource1/edit.scala.html
                    HASH: 96fe636a6b94b14d6edcaaebbb57ba7ff0d09501
