...
<li><a href=""""),_display_(Seq[Any](/*5.15*/routes/*5.21*/.Resource2.get(id))),format.raw/*5.39*/("""">"""),_display_(Seq[Any](/*5.42*/id)),format.raw/*5.44*/("""</a></li>
""")))})),format.raw/*6.2*/("""
</ul>

<a href=""""),_display_(Seq[Any](/*9.11*/routes/*9.17*/.Resource2.create())),format.raw/*9.36*/("""">Create</a>
"""))}
    }
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource2/index.scala.html
                    HASH: 2eed534ad136da8602c1712c6fda7d1ba5746e57
