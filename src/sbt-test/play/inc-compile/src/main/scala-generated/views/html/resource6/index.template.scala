...
<li><a href=""""),_display_(Seq[Any](/*5.15*/routes/*5.21*/.Resource6.get(id))),format.raw/*5.39*/("""">"""),_display_(Seq[Any](/*5.42*/id)),format.raw/*5.44*/("""</a></li>
""")))})),format.raw/*6.2*/("""
</ul>

<a href=""""),_display_(Seq[Any](/*9.11*/routes/*9.17*/.Resource6.create())),format.raw/*9.36*/("""">Create</a>
"""))}
    }
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: /Users/jroper/tmp/scala-compilation-times/app/views/resource6/index.scala.html
                    HASH: cef29e5aa41540b20936129358885f308f350610
